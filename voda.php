...
<head>
    ...
    <style>
        body{
        background-image: url(img/vodacom-headquarters-car-park.jpg);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <?php echo $usuario['nome'].' '.$usuario['apelido'];?>
        ...
        <div class="filho">
        <fieldset>
        <form action="server/creditoVoda.php" method="POST">
        <h2> Compra credito </h2>
            ...
            <br><br>
            <input type="text" id="numero contador" name="numeroCelular" placeholder="Digite o numero do celular (84/85)"  minlength="9" maxlength="9"  >
