...
<html lang="en">
    <head>
        ...
        <style>
            body{
                background-image: url(img/pexels-pok-rie-157827.jpg);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <?php echo $usuario['nome'].' '.$usuario['apelido'];?>
        ...
        <div class="filho">
            <fieldset>
                <form action="server/compraCredelec.php" method="POST">
                    <h2> Comprar Credelec </h2>
                    <br>
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <input type="text" id="numeroContador" name="numeroContador" placeholder="Digite o numero do contador"  minlength="12" maxlength="12" >
                    ...
                    <a href="menu.php" class="btn btn-danger form-control"><i class="fas fa-times-circle"></i> Cancelar</a>
                    </div>
                </form>
            </fieldset>
        </div>
