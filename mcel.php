...
<html lang="en">
    <head>
        ...
        <style>
            body{
                background-image: url(img/Rrrmcel.jpg);
  ...
  <div class="container-fluid">
    ...
    <fieldset>
    <form action="server/creditoMcel.php" method="POST">
    ...
    <span class="text-success"><b><?php echo $_SESSION['success']; unset($_SESSION['success']); ?></b></span>
                    ...
                    <br>
                    <br>
                    <input type="text" id="numeroCelular" name="numeroCelular" placeholder="Digite o numero do celular (82/83)" minlength="9" maxlength="9" >
